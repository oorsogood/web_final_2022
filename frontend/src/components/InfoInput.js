		...
		<div className={classes.rightLayout}>
			<div className={classes.requiredField}>
				...
				<div>
					...
					<div className={classes.PostTitle} onFocus={props.handleOthersOnFocus}>
						<TextField
							label="Where are you?"
							variant="outlined"
				...
				{props.selectedImages.length > 0 &&
					(props.selectedImages.length > 10 ? (
						<p className={classes.error}>
							You can't upload more than <b>10</b> images! Please delete <b>{props.selectedImages.length - 10}</b> images.
							{/* <br />
							<span>
					...
					{props.tagsOnFocus && (
						<div>
							<p className={classes.enterTags}>
								Press <b>Enter</b> to add new tags and press <b>Backspace</b> to remove.
							</p>
						</div>
					)}
				</div>
